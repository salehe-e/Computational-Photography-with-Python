...
def split_rgb(image):
  ...
  '''image = cv2.imread('E:\Queen Mary University of London\Courses\Coursera\4- Computational Photography - Georgia Institute of Technology - Irfan Essa\Module 0\hw0\hw0\images\part0\kitten.jpg')'''

  red = np.zeros((image.shape[0],image.shape[1]), dtype=image.dtype)
  green = np.zeros((image.shape[0],image.shape[1]), dtype=image.dtype)
  blue = np.zeros((image.shape[0],image.shape[1]), dtype=image.dtype)

  red[:,:] = image[:,:,2]
  green[:,:] = image[:,:,1]
  blue[:,:] = image[:,:,0]

  '''cv2.imwrite('E:\Queen Mary University of London\Courses\Coursera\4- Computational Photography - Georgia Institute of Technology - Irfan Essa\Module 0\hw0\hw0\images\part0\red_out.jpg', red)
  cv2.imwrite('E:\Queen Mary University of London\Courses\Coursera\4- Computational Photography - Georgia Institute of Technology - Irfan Essa\Module 0\hw0\hw0\images\part0\green_out.jpg', green)
  cv2.imwrite('E:\Queen Mary University of London\Courses\Coursera\4- Computational Photography - Georgia Institute of Technology - Irfan Essa\Module 0\hw0\hw0\images\part0\blue_out.jpg', blue)'''
